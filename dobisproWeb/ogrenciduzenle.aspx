<%@ Page Title="" Language="C#" MasterPageFile="~/anamaster.master" AutoEventWireup="true" CodeFile="ogrenciduzenle.aspx.cs" Inherits="ogrenciler" %>
    ...
    <div class="form-group">
        <table class="table">
            <tr>
                ...
                <td><img id="blah" /><div id="oldresim"><asp:literal ID="ltresim" runat="server"></asp:literal></div></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td><asp:TextBox ID="txtSifre" class="tcno" MaxLength="11" runat="server" placeholder="Şifre" CssClass="form-control"></asp:TextBox></td>
            </tr>
            <tr>
