<%@ Page Title="" Language="C#" MasterPageFile="~/anamaster.master" AutoEventWireup="true" CodeFile="slaytduzenle.aspx.cs" Inherits="slaytduzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="form-group">
        ...
        <asp:TextBox ID="txtNmbrSayi" TextMode="Number" required="required" data-validate-minmax="0,100" placeholder="Resim Sıra" class="form-control" runat="server" /><br />
